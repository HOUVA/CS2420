...
public class UHealthID {
	...
	/**
	 * Parses the given string to create a UHealthID. This assumes the format
	 * AAAA-0000 where "A" could be any English letter and "0" could be any
	 * numerical digit.
	 * 
	...
	/**
	 * Returns a textual representation of this UHealth ID. This is prefix + '-' +
	 * suffix.
	 * 
