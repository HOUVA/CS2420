 ...
 * UHealthIDs. More specifically, the comparison is based on the string
 * representation of the ID UHealthIDs are guaranteed to be unique, making a
 * tie-breaker unnecessary.
 * 
