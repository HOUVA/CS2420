...
class LargestNumberSolverTester {
	...
	public void testFindLargestIntTooLarge() {
		assertThrows(OutOfRangeException.class, () -> {LargestNumberSolver.findLargestInt(integerArray);});
	}
	...
	public void testFindLargestLongTooLarge() {
		assertThrows(OutOfRangeException.class, () -> {LargestNumberSolver.findLargestLong(longArray);});
	}
